...
export default function ComparisonDisplay({ comparisonData }: { comparisonData: any }) {
  ...
  return (
    ...
    >
      <h2 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-yellow-500 mb-4 text-center">GitHub Comparison</h2>
