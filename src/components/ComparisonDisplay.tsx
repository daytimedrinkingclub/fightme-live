  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className={`p-4 ${winner === comparisonData.name1 ? 'bg-gray-800' : 'bg-gray-700'} rounded-lg shadow-md w-full md:w-1/2 mx-2 text-center mb-4 md:mb-0`}>
        ...
        <div className={`p-4 ${winner === comparisonData.name2 ? 'bg-gray-800' : 'bg-gray-700'} rounded-lg shadow-md w-full md:w-1/2 mx-2 text-center`}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
